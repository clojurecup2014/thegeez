...
{{
var G__14676 = cljs.core.pop.call(null,v__$1);
v__$1 = G__14676;
continue;
}
} else
...
{var pred__14680 = cljs.core._EQ_;var expr__14681 = limit;if(cljs.core.truth_(pred__14680.call(null,(1),expr__14681)))
{return (new cljs.core.PersistentVector(null,1,(5),cljs.core.PersistentVector.EMPTY_NODE,[s],null));
} else
{if(cljs.core.truth_(pred__14680.call(null,(2),expr__14681)))
...
var G__14683 = s__$1.substring((index + cljs.core.count.call(null,m)));
var G__14684 = (limit__$1 - (1));
var G__14685 = cljs.core.conj.call(null,parts,s__$1.substring((0),index));
s__$1 = G__14683;
limit__$1 = G__14684;
parts = G__14685;
continue;
...
{var ch = s.charAt(index);var temp__4124__auto___14687 = cljs.core.get.call(null,cmap,ch);if(cljs.core.truth_(temp__4124__auto___14687))
{var replacement_14688 = temp__4124__auto___14687;buffer.append((''+cljs.core.str.cljs$core$IFn$_invoke$arity$1(replacement_14688)));
} else
{buffer.append(ch);
}
{
var G__14689 = (index + (1));
index = G__14689;
continue;
}
}
